...
def test_get_ip() -> None:
    # given
    pb_test, expected_test = syn_test_builder.make_ip_test_pair()
...
def test_create_ip() -> None:
    # given
    pb_test, input_test = syn_test_builder.make_ip_test_pair()
