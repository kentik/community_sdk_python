...
def test_get_kentik_com_client__return_com_api_client():
    ...
    # THEN
    assert isinstance(client, Client)
    assert client.host == kentik_fluent_api_client.BASE_API_COM_URL
...
def test_get_kentik_com_client__return_eu_api_client():
    ...
    # WHEN
    client = kentik_fluent_api_client.get_kentik_eu_client(DUMMY_EMAIL, DUMMY_API_TOKEN)

    # THEN
    assert isinstance(client, Client)
    assert client.host == kentik_fluent_api_client.BASE_API_EU_URL
