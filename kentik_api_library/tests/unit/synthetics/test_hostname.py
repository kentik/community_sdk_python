...
def test_get_hostname() -> None:
    # given
    pb_test, expected_test = syn_test_builder.make_hostname_test_pair()
...
def test_create_hostname() -> None:
    # given
    pb_test, input_test = syn_test_builder.make_hostname_test_pair()
