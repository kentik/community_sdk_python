...
def test_get_dns_grid() -> None:
    # given
    pb_test, expected_test = syn_test_builder.make_dns_grid_test_pair()
...
def test_create_dns_grid() -> None:
    # given
    pb_test, input_test = syn_test_builder.make_dns_grid_test_pair()
