...
def test_get_page_load() -> None:
    # given
    pb_test, expected_test = syn_test_builder.make_page_load_test_pair()
...
def test_create_page_load() -> None:
    # given
    pb_test, input_test = syn_test_builder.make_page_load_test_pair()
...
def test_update_page_load() -> None:
    # given
    pb_test, input_test = syn_test_builder.make_page_load_test_pair()
    connector = StubAPISyntheticsConnector()
    client = KentikSynthClient(connector)
